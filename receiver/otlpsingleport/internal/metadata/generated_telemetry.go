...
func NewTelemetryBuilder(settings component.TelemetrySettings, options ...TelemetryBuilderOption) (*TelemetryBuilder, error) {
	...
	builder.OtlpsingleportRequestsRefused, err = builder.meter.Int64Counter(
		...
		metric.WithDescription("Requests refused before they reach the pipeline, by transport (grpc, http) and reason (method, media_type, body_too_large, decode, unknown_path, decompress). Refusals by the pipeline itself are receiver_refused_*. [Development]"),
